        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ URL::To('admin/experiance/attribute/add-action-attribute')}}" method="post">
                            @csrf
                                ...
                                <tbody class="table-border-bottom-0" >
                                  @foreach ($lists as $key => $cat)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ URL::To('admin/experiance/attribute/edit', $cat->id) }}"><i class="fa fa-solid fa-pen-to-square"></i></a>
                                            <a href="{{ URL::To('admin/experiance/attribute/delete', $cat->id) }}" onclick="deleteConfirmation(event)"><i class="fa fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                  @endforeach
